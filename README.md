...
**gtdb2rdo_train_files.py ** - A python3 script for parsing 16S rRNA gene sequences downloaded from GTDB and creating the files rawSeqs.fasta and rawTaxonomy.txt required for training the RDP Classifier.
